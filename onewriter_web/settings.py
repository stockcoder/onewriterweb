"""
Django settings for Academic AI Writer project.
...
SECRET_KEY = env("SECRET_KEY", default="FUaOyctIlRlBUriaodwYrEennnjapBVmNSpDpdJw")
...
ROOT_URLCONF = "onewriter_web.urls"
...
WSGI_APPLICATION = "onewriter_web.wsgi.application"
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "onewriter_web_language"
...
EMAIL_SUBJECT_PREFIX = "[Academic AI Writer] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Academic AI Writer",
    "DESCRIPTION": "AI writer specifically developed for academic",
    "VERSION": "0.1.0",
...
ASGI_APPLICATION = "onewriter_web.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
WAGTAIL_SITE_NAME = "Academic AI Writer Content"
WAGTAILADMIN_BASE_URL = "http://onewriter.ai"
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("Academic AI Writer"),
    "URL": "http://onewriter.ai",
    "DESCRIPTION": gettext_lazy("AI writer specifically developed for academic"),
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "yong@onewriter.ai",
}

USE_HTTPS_IN_ABSOLUTE_URLS = False  # set this to True in production to have URLs generated with https instead of http

ADMINS = [("yong", "yong@onewriter.ai")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "onewriter_web": {
            "handlers": ["console"],
            "level": env("ONEWRITER_WEB_LOG_LEVEL", default="INFO"),
        },
    },
}
